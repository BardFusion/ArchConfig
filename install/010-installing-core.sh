...
arch-chroot /mnt /bin/bash #./020-configuring-core.sh $DEVICE_ID $NEW_USER_NAME $HOST_NAME $INTEL_INSTALL $GPU_TYPE $LAPTOP_INSTALL $PRINTER_INSTALL $ROOT_PASSWORD $USER_PASSWORD
clear
